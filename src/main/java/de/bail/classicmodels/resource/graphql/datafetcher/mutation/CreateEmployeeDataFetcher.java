...
/**
 * Create Employee Data Fetcher
 */
public class CreateEmployeeDataFetcher implements DataFetcher<Employee> {

    private final EmployeeService service;

    private final ObjectMapper mapper = new ObjectMapper();

    public CreateEmployeeDataFetcher(EmployeeService service) {
